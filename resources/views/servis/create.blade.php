...
@section('title', 'Check-In Servis')

@section('content')
<div class="d-flex align-items-center gap-2 mb-3">
    <i class="bi bi-box-arrow-in-right fs-2 text-primary"></i>
    <h1 class="mb-0">Check-In Servis</h1>
</div>
        ...
        <form action="{{ route('admin.servis.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select name="tipe_barang" class="form-select @error('tipe_barang') is-invalid @enderror">
                        ...
                        <option value="motor" {{ old('tipe_barang') === 'motor' ? 'selected' : '' }}>Motor</option>
                        <option value="mobil" {{ old('tipe_barang') === 'mobil' ? 'selected' : '' }}>Mobil</option>
                        <option value="lainnya" {{ old('tipe_barang') === 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                    </select>
            ...
            <div class="mb-3">
                ...
                <textarea name="keluhan" class="form-control @error('keluhan') is-invalid @enderror"
                    rows="3" required placeholder="Deskripsi keluhan pelanggan...">{{ old('keluhan') }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea name="kelengkapan" class="form-control @error('kelengkapan') is-invalid @enderror"
                    rows="2" placeholder="Catat kelengkapan yang dibawa pelanggan (STNK, kunci, helm, jas hujan, dll)">{{ old('kelengkapan') }}</textarea>
                <div class="form-text">Catat perlengkapan yang dibawa pelanggan untuk menghindari kehilangan.</div>
            ...
            <div class="card border-primary mb-3">
                ...
                <div class="card-footer text-end">
                    <strong>Subtotal Sparepart:</strong> <span id="sparepartSubtotal">Rp 0</span>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="biaya" id="biaya" class="form-control @error('biaya') is-invalid @enderror"
                        value="{{ old('biaya') ? number_format(old('biaya'), 0, ',', '.') : '0' }}" inputmode="numeric" required
                        onkeyup="this.value=formatRupiah(this.value); hitungTotalBiaya();">
                    <div class="form-text">Biaya di luar paket (isi 0 jika sudah termasuk paket)</div>
                    @error('biaya')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label">Total Biaya</label>
                    <h3 id="totalBiayaDisplay">Rp 0</h3>
                    <input type="hidden" id="totalBiayaHidden" value="0">
                ...
                <div class="col-md-2 mb-3 d-flex align-items-end">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="cetakNota" checked>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary btn-lg">
                    <i class="bi bi-check-lg"></i> Check-In Servis
                </button>
...
<template id="templateSparepart">
    <div class="row g-2 mb-2 sparepart-row">
        ...
        <div class="col-md-3">
            <span class="sparepart-subtotal d-inline-block mt-2">Rp {{ number_format(0, 0, ',', '.') }}</span>
        </div>
